...
namespace FitnessPlanner.Data.Migrations
{
    ...
    [Migration("20241125192838_AddRelationshipBetweenUserAndWorkoutPlanAsManyToMany")]
    partial class AddRelationshipBetweenUserAndWorkoutPlanAsManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.BodyMassIndexMeasure", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the body mass index measure.");
                    ...
                    b.Property<string>("Type")
                        ...
                        .HasColumnName("type")
                        .HasComment("The type of the body mass index measure.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.Exercise", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the exercise.");
                    ...
                    b.Property<string>("Explanation")
                        ...
                        .HasComment("The explanation of the exercise.");
                    ...
                    b.Property<string>("ImageName")
                        ...
                        .HasComment("The name of the image associated with the exercise.");
                    ...
                    b.Property<string>("PerformTip")
                        ...
                        .HasComment("Tips for performing the exercise.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.ExerciseMuscleGroup", b =>
                {
                    b.Property<int>("ExerciseId")
                        ...
                        .HasComment("The ID of the associated exercise.");

                    b.Property<int>("MuscleGroupId")
                        .HasColumnType("integer")
                        .HasColumnName("muscle_group_id")
                        .HasComment("The ID of the associated muscle group.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.ExercisePerformInfo", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the exercise performance information.");
                    ...
                    b.Property<int>("Reps")
                        .HasColumnType("integer")
                        .HasColumnName("reps")
                        .HasComment("The number of repetitions for each set of the exercise.");

                    b.Property<int>("Sets")
                        .HasColumnType("integer")
                        .HasColumnName("sets")
                        .HasComment("The number of sets for the exercise.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.ExercisePerformInfoSingleWorkout", b =>
                {
                    b.Property<int>("ExercisePerformInfoId")
                        ...
                        .HasComment("The ID of the associated exercise performance information.");

                    b.Property<int>("SingleWorkoutId")
                        .HasColumnType("integer")
                        .HasColumnName("single_workout_id")
                        .HasComment("The ID of the associated single workout.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.Goal", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the goal.");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasColumnName("name")
                        .HasComment("The name of the goal.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.MuscleGroup", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the muscle group.");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasColumnName("name")
                        .HasComment("The name of the muscle group.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.SingleWorkout", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the single workout.");
                    ...
                    b.Property<int>("Day")
                        .HasColumnType("integer")
                        .HasColumnName("day")
                        .HasComment("The day of the week on which the single workout is scheduled.");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasColumnName("name")
                        .HasComment("The name of the single workout.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.SkillLevel", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the skill level.");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasColumnName("name")
                        .HasComment("The name of the skill level.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.WorkoutPlan", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasComment("The unique identifier for the workout plan.");
                    ...
                    b.Property<int>("GoalId")
                        ...
                        .HasComment("The ID of the goal associated with the workout plan.");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("name")
                        .HasComment("The name of the workout plan.");

                    b.Property<int>("SkillLevelId")
                        .HasColumnType("integer")
                        .HasColumnName("skill_level_id")
                        .HasComment("The ID of the skill level associated with the workout plan.");

                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
                        .HasColumnName("user_id")
                        .HasComment("The ID of the user associated with the workout plan.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.WorkoutPlanBodyMassIndexMeasure", b =>
                {
                    ...
                    b.Property<int>("BodyMassIndexMeasureId")
                        ...
                        .HasComment("The ID of the associated body mass index measure.");
            ...
            modelBuilder.Entity("FitnessPlanner.Data.Models.User", b =>
                {
                    ...
                    b.Property<int>("BodyMassIndexMeasureId")
                        .HasColumnType("integer")
                        .HasColumnName("body_mass_index_measure_id")
                        .HasComment("The ID of the body mass index measure associated with the user.");
                    ...
                    b.Property<int>("GoalId")
                        .HasColumnType("integer")
                        .HasColumnName("goal_id")
                        .HasComment("The ID of the goal associated with the user.");
                    ...
                    b.Property<int>("SkillLevelId")
                        .HasColumnType("integer")
                        .HasColumnName("skill_level_id")
                        .HasComment("The ID of the skill level associated with the user.");
