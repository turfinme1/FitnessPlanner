...
{
    /// <inheritdoc />
    public partial class AddBodyMassIndexEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_body_mass_index_measure_id", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "body_mass_index_measure_id",
                        principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_user_body_mass_index_measure_id_body_mass_index_measure_id",
                table: "user",
                column: "body_mass_index_measure_id",
                principalTable: "body_mass_index_measure_id",
                principalColumn: "id");
